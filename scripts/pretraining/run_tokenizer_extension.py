...
def build_parser():
    ...
    parser.add_argument(
        '--log-dir',
        type=str,
        default=str(REPO_ROOT / 'logs' / 'pretraining' / 'tokenizer_extension'),
...
def main():
    ...
    log_filename = f"TokenizerExt_{base_model_name}_{in_name}_{args.max_vocab_size}vocab_min{args.min_freq}_{timestamp}.log"
